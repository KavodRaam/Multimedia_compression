...
def motion_kernel(angle, d, sz=500):
...
if __name__ == '__main__':
    ...
    opts = dict(opts)
    try: fn = args[0]
    except: fn = 'license_plate_defocus.jpg'
    ...
    def update(_):
        ...
        PSF2 = (PSF**2).sum(-1)
        dft = cv2.resize(PSF2, (300,100))
        cv2.imshow('DFT of PSF', dft)
    ...
    cv2.createTrackbar('d', win, int(opts.get('--d', 22)), 500, update)
